...
(1, 'Vintage Leather Jacket', 'Genuine leather jacket from the 80s, size M. Great condition, no damages.', 'fashion', 50.00, 75.00, 150.00, 'Пловдив', 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=500', CURRENT_TIMESTAMP + INTERVAL '1 day'),
...
(1, 'MacBook Air M1', '2021 MacBook Air with M1 chip, 8GB RAM, 256GB SSD. Perfect working condition.', 'electronics', 700.00, 750.00, 1000.00, 'София', 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=500', CURRENT_TIMESTAMP + INTERVAL '4 days'),
